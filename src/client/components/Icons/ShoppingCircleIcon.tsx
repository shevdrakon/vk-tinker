...
const ShoppingCircleIcon = (props: IIcon) => {
  return (
	...
	S496.2,385.1,496.2,248.1z" />
      <path fill="#526B70" d="M442.4,247.2c0,8.2-5.8,14.8-13,14.8h-67.1c-7.1,0-13-6.6-13-14.8l0,0c0-8.2,5.8-14.8,13-14.8h67.1
	C436.6,232.3,442.4,239,442.4,247.2L442.4,247.2z" />
      <path fill="#526B70" d="M413.5,244.3c0-10.8-61.5-77.3-83.5-77.3H113.3C91.2,167,80,179.6,80,201.7v86.6
  ...
  {/*    <path fill="white" d="M269.4,213.5c0,6.6-7.5,11.3-7.9,10.7c-5.6-6.4-15.1-11.3-24.8-11.3c-9.8,0-15.8,4.4-15.8,11*/}
	...
	{/*h0.9c6,0,8.3,3.1,8.3,10v5C260.5,198.7,269.4,206,269.4,213.5z" />*/}
      <path fill="#F7F5ED" d="M442.4,250.2c0,7.2-5.8,13-13,13H362c-7.2,0-13-5.8-13-13l0,0c0-7.2,5.8-13,13-13h67.4
	C436.6,237.2,442.4,243,442.4,250.2L442.4,250.2z" />
    </Icon>
  )
};

export default ShoppingCircleIcon;
